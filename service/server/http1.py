...
from service.errors import HttpError
from service.headers import Headers, HeaderParseError
from service.streamutils import BufferedBodyReader, ChunkedBodyReader
from service.utils import HTTP_STATUSES, SUPPORTED_METHODS
from service.server.router import RoutingError
from service.server.handlers import Request, Response
from service.server.handlers import Connection, ProtocolHandler
...
class Http1Pipeline(ProtocolHandler):
    ...
    async def _handle_request(self):
        ...
        can_continue = self.handler.do_filter()
